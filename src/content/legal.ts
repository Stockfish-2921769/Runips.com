...
const zhPrivacy: LegalDocumentContent = {
  ...
  sections: [
    ...
    },
    {
      title: '2. 我们处理的数据',
      bullets: [
        '账号与认证数据：匿名账号的随机内部 ID、身份记录、会话和登录时间。使用 Google 创建或升级持久账号时，我们会处理 Google 提供的唯一标识、邮箱、邮箱验证状态、Google Workspace 托管域名、登录时间和基础认证资料。Google 也可能在身份记录中提供姓名或头像链接；RunIPS 不会将它们直接用作公开昵称或头像。',
    ...
    },
    {
      ...
      bullets: [
        ...
        '合法利益（第 6(1)(f) 条）：根据经 Google 验证的邮箱和 Workspace 托管域名，在服务器端签发 `waseda-verified` 标识，帮助读者识别曾控制早稻田域名 Google 账号的参与者并减少冒充。该标识不证明当前学生、教职员、校友或 IPS 身份；你的邮箱和托管域名不会公开。你可以通过 Contact 提出反对。',
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        '`waseda-verified` 仅表示登录时验证了相符的早稻田域名 Google Workspace 邮箱。不得把该标识描述为在读、任职、校友、IPS 所属或校方认可的证明。',
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        'Legitimate interests (Article 6(1)(f)): issuing a server-side `waseda-verified` badge from a Google-verified email address and matching Workspace hosted domain, so readers can recognise participants who controlled a Waseda-domain Google account and impersonation is harder. The badge does not prove current student, staff, alumni, or IPS status; neither the email nor hosted domain is public. You may object through Contact.',
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        'The `waseda-verified` badge means only that a matching Waseda-domain Google Workspace email was verified at sign-in. Do not present it as proof of current enrolment, employment, alumni status, IPS affiliation, or university endorsement.',
